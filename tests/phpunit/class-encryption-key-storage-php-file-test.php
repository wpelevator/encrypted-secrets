...
class Encryption_Key_Storage_PHP_File_Test extends TestCase {

	public function test_writable_dir_is_supported() {
		$storage = new Encryption_Key_Storage_PHP_File( __DIR__ . '/stubs/secret-sodium-generated.php' );
	...
	public function test_non_writable_dir_is_not_supported() {
		$storage = new Encryption_Key_Storage_PHP_File( '/some/directory/here/far-away' );
